      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h4 className="font-mono text-[#48A9A6] text-sm tracking-wider mb-3">MODERN INFRASTRUCTURE</h4>
              <h1 className="font-serif text-5xl md:text-6xl leading-none tracking-tight text-[#254E70]">
                ...
                <span className="font-light"> WordPress</span>
              </h1>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-[#254E70]/80">
                  <span className="font-medium text-[#254E70]">2-5x faster page loads</span> with static generation and optimized assets
                </p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="text-[#254E70]/80">
                  <span className="font-medium text-[#254E70]">Familiar admin experience</span> with the WordPress backend you already know
                </p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="text-[#254E70]/80">
                  <span className="font-medium text-[#254E70]">Seamless AI integration</span> without complex backend modifications
                </p>
              </div>
            </div>
            ...
            <div className="relative aspect-[4/3] flex flex-col">
              ...
              <div className="absolute left-0 top-0 w-4/5 h-40 bg-white rounded-sm shadow-md border border-[#254E70]/10 p-5 z-10">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="font-serif text-lg text-[#254E70]">Traditional WordPress</h3>
                </div>
                <div className="bg-[#254E70]/5 p-3 rounded-sm">
                  ...
                  <div className="mt-1 h-20 rounded-sm bg-[#254E70]/10 flex items-center justify-center">
                    <span className="font-mono text-xs text-[#254E70]/40">Monolithic Architecture</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute left-4 top-[120px] w-full h-64 flex space-x-6 z-20">
                ...
                <div className="w-1/2 bg-white rounded-sm shadow-md border border-[#254E70]/10 p-5">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="font-serif text-lg text-[#48A9A6]">WordPress Backend</h3>
                  </div>
                  <div className="bg-[#48A9A6]/5 p-3 rounded-sm h-[120px] flex flex-col justify-between">
                    ...
                    <div className="flex justify-end">
                      <div className="bg-[#48A9A6] text-white text-xs py-1 px-2 rounded-sm font-mono">REST API</div>
                    </div>
                  </div>
                ...
                <div className="w-1/2 bg-white rounded-sm shadow-md border border-[#254E70]/10 p-5">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="font-serif text-lg text-[#D97C4E]">Modern Frontend</h3>
                  </div>
                  <div className="bg-[#D97C4E]/5 p-3 rounded-sm h-[120px] flex flex-col justify-between">
                    <div className="space-y-2">
                      ...
                      <div className="h-12 rounded-sm bg-[#D97C4E]/10 flex items-center justify-center">
                        <span className="font-mono text-xs text-[#D97C4E]/40">React / Next.js</span>
                      </div>
                    </div>
                    <div className="flex justify-end">
                      <div className="bg-[#D97C4E] text-white text-xs py-1 px-2 rounded-sm font-mono">Static Generation</div>
                    </div>
                  </div>
                  <div className="mt-3 flex justify-center">
                    <div className="text-xs text-center text-[#254E70]/60 max-w-[140px]">
              ...
              <div className="absolute right-0 bottom-0 w-2/3 bg-white/80 backdrop-blur-sm rounded-sm shadow-md border border-[#254E70]/10 p-4 z-30">
                <h4 className="font-mono text-xs text-[#254E70] uppercase tracking-wider mb-3">Performance Metrics</h4>
                <div className="space-y-2">
                  <div className="flex items-center">
                    <div className="w-28 text-xs text-[#254E70]/70">Page Load Speed</div>
                    ...
                    <div className="ml-2 text-xs font-medium text-[#D97C4E]">85%</div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="w-28 text-xs text-[#254E70]/70">Mobile UX</div>
                    <div className="flex-grow h-3 bg-[#254E70]/10 rounded-full relative">
                      <div className="absolute inset-y-0 left-0 bg-[#D97C4E] rounded-full w-[90%]"></div>
                    </div>
                    <div className="ml-2 text-xs font-medium text-[#D97C4E]">90%</div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="w-28 text-xs text-[#254E70]/70">SEO Score</div>
                    <div className="flex-grow h-3 bg-[#254E70]/10 rounded-full relative">
                      <div className="absolute inset-y-0 left-0 bg-[#D97C4E] rounded-full w-[95%]"></div>
                    </div>
                    <div className="ml-2 text-xs font-medium text-[#D97C4E]">95%</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 max-w-3xl mx-auto">
          <div className="bg-white rounded-sm p-6 shadow-sm border border-[#254E70]/10 relative">
            ...
            <blockquote className="text-[#254E70]/80 text-lg italic relative">
              ...
              Implementing headless WordPress transformed our digital presence. Page load times decreased by 68%, and our team still uses the familiar WordPress interface they know and love.
            ...
            <div className="mt-4 flex items-center">
              ...
              <div className="ml-3">
                <div className="font-medium text-[#254E70]">Dr. Maria Hernandez</div>
                <div className="text-[#254E70]/60 text-sm">Digital Director, Pacific Maritime Museum</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="bg-white py-20">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="font-serif text-4xl text-[#254E70] mb-6">Transforming Cultural Experiences</h2>
          <p className="text-[#254E70]/70 text-lg">
            Discover how museums and cultural institutions have revolutionized their digital presence with our headless WordPress solutions.
          </p>
        </div>
            ...
            <div className="bg-[#F2EEE4] rounded-sm overflow-hidden transition-all duration-300 h-full flex flex-col hover:shadow-md">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-full h-full bg-[#254E70]/5 flex items-center justify-center">
                    <div className="text-center p-6">
                      ...
                      <h3 className="font-serif text-xl text-[#254E70]">The Guggenheim Museum</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                <p className="text-[#254E70]/80 mb-4">
                  One of the world's most renowned museums chose headless WordPress for their site redesign, implementing an AngularJS frontend that dramatically improved page load times and user experience.
                </p>
                
                <h4 className="font-medium text-[#254E70] mb-2">Key Results:</h4>
                <ul className="space-y-2 mb-6 text-[#254E70]/70">
                  <li className="flex items-start">
                    ...
                    <span>68% decrease in load times</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#D97C4E] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Complex information architecture support</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#D97C4E] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Improved content delivery flexibility</span>
                  </li>
                </ul>
          ...
          <div className="group relative">
            <div className="bg-[#F2EEE4] rounded-sm overflow-hidden transition-all duration-300 h-full flex flex-col hover:shadow-md">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-full h-full bg-[#254E70]/5 flex items-center justify-center">
                    <div className="text-center p-6">
                      ...
                      <h3 className="font-serif text-xl text-[#254E70]">Pacific Maritime Museum</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                <p className="text-[#254E70]/80 mb-4">
                  This regional maritime museum transitioned to a headless architecture to better showcase their digital archives and interactive exhibits while maintaining their familiar content workflow.
                </p>
                ...
                <ul className="space-y-2 mb-6 text-[#254E70]/70">
                  <li className="flex items-start">
                    ...
                    <span>95% improvement in SEO rankings</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#48A9A6] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Enhanced archival search capabilities</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#48A9A6] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Triple the virtual exhibit engagement</span>
                  </li>
                </ul>
          ...
          <div className="group relative">
            <div className="bg-[#F2EEE4] rounded-sm overflow-hidden transition-all duration-300 h-full flex flex-col hover:shadow-md">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-full h-full bg-[#254E70]/5 flex items-center justify-center">
                    <div className="text-center p-6">
                      ...
                      <h3 className="font-serif text-xl text-[#254E70]">National Cultural Heritage Center</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                <p className="text-[#254E70]/80 mb-4">
                  This institution needed to manage content in multiple languages while preserving cultural artifacts in digital form, leading them to implement a headless solution with a custom React frontend.
                </p>
                ...
                <ul className="space-y-2 mb-6 text-[#254E70]/70">
                  <li className="flex items-start">
                    ...
                    <span>Content managed in 12 languages</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#946B4A] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Integrated with 3D artifact viewer</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#946B4A] mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>54% increase in international visitors</span>
                  </li>
                </ul>
        ...
        <div className="mt-20 bg-white rounded-sm shadow-sm border border-[#254E70]/10 overflow-hidden">
          <div className="px-6 py-5 border-b border-[#254E70]/10 flex justify-between items-center">
            <h3 className="font-serif text-2xl text-[#254E70]">Implementation Comparison</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[#F2EEE4]">
                  <th className="py-4 px-6 text-left text-[#254E70] font-medium">Feature</th>
                  <th className="py-4 px-6 text-left text-[#D97C4E] font-medium">Guggenheim</th>
                  <th className="py-4 px-6 text-left text-[#48A9A6] font-medium">Maritime Museum</th>
                  <th className="py-4 px-6 text-left text-[#946B4A] font-medium">Heritage Center</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#254E70]/10">
                <tr>
                  <td className="py-4 px-6 text-[#254E70]/80">Frontend Framework</td>
                  <td className="py-4 px-6">AngularJS</td>
                  <td className="py-4 px-6">Next.js</td>
                  <td className="py-4 px-6">React</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-[#254E70]/80">Build Strategy</td>
                  <td className="py-4 px-6">Dynamic Rendering</td>
                  <td className="py-4 px-6">Static Generation</td>
                  <td className="py-4 px-6">Hybrid Rendering</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-[#254E70]/80">Content Structure</td>
                  <td className="py-4 px-6">Custom Post Types</td>
                  <td className="py-4 px-6">ACF Blocks</td>
                  <td className="py-4 px-6">Custom Taxonomy</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-[#254E70]/80">API Integration</td>
                  <td className="py-4 px-6">REST API</td>
                  <td className="py-4 px-6">REST API + GraphQL</td>
                  <td className="py-4 px-6">WPGraphQL</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-[#254E70]/80">Hosting Solution</td>
                  <td className="py-4 px-6">AWS</td>
                  <td className="py-4 px-6">Netlify</td>
                  <td className="py-4 px-6">Vercel</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mt-20 text-center">
          <h3 className="font-serif text-2xl text-[#254E70] mb-6">Ready to transform your institution's digital presence?</h3>
          <p className="text-[#254E70]/70 max-w-2xl mx-auto mb-8">
            Join these leading cultural institutions in creating a faster, more flexible online experience while maintaining the familiar WordPress admin interface your team knows and loves.
          </p>
    ...
    <section className="bg-white py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Text content */}
          <div>
            <h4 className="font-mono text-[#D97C4E] text-sm tracking-wider mb-3">ABOUT HEADLESS WORDPRESS</h4>
            <h2 className="font-serif text-4xl md:text-5xl text-[#254E70] mb-6">Decoupled Architecture for Modern Institutions</h2>
            
            <div className="space-y-6 text-[#254E70]/80">
              <p>
                Headless WordPress separates your content management system (the "back end") from your visitor-facing website (the "front end"), creating a more flexible, powerful digital presence while maintaining the familiar WordPress editing experience.
              </p>
              
              <p>
                For museums and cultural institutions, this approach unlocks new possibilities for presenting collections, engaging visitors, and integrating advanced technologies like AI—all while improving performance, security, and accessibility.
              </p>
              
              <div className="py-4 border-t border-b border-[#254E70]/10 my-8">
                <h3 className="font-serif text-xl text-[#254E70] mb-4">Key Benefits for Cultural Institutions</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="text-[#254E70]/80">
                      <span className="text-[#254E70] font-medium">Lightning-Fast Performance</span> — Static site generation delivers 2-5x faster page loads, improving visitor satisfaction and SEO rankings
                    </p>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="text-[#254E70]/80">
                      <span className="text-[#254E70] font-medium">Future-Ready Architecture</span> — Easily integrate AI, personalization, and interactive elements as your digital strategy evolves
                    </p>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="text-[#254E70]/80">
                      <span className="text-[#254E70] font-medium">Familiar Content Management</span> — Staff continue using the WordPress interface they already know and love
                    </p>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="text-[#254E70]/80">
                      <span className="text-[#254E70] font-medium">Enhanced Security</span> — Reduced attack surface with a static frontend that's separate from your database
                    </p>
                  </div>
                </div>
              </div>
              
              <h3 className="font-serif text-xl text-[#254E70] mb-4">Why Museums Choose Headless</h3>
              <p>
                Cultural institutions face unique digital challenges: presenting complex collections, accommodating diverse audiences, and balancing innovation with limited IT resources. Headless WordPress provides the perfect solution—powerful yet familiar, flexible yet reliable.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="mb-12 relative">
              <div className="text-center mb-4">
                <h4 className="inline-block font-serif text-lg text-[#254E70] px-4 py-1 bg-[#254E70]/5 rounded-sm">Traditional WordPress</h4>
              </div>
              ...
              <div className="relative aspect-[5/3] border border-[#254E70]/10 rounded-sm bg-[#F2EEE4] p-4 shadow-sm">
                ...
                <div className="absolute inset-0 m-4 border-4 border-[#254E70]/20 border-dashed rounded-sm flex flex-col overflow-hidden">
                  ...
                  <div className="bg-[#254E70]/10 p-4 h-1/2 border-b-2 border-[#254E70]/20 border-dashed flex flex-col">
                    <div className="text-center text-[#254E70] font-mono text-sm mb-2">WORDPRESS BACKEND</div>
                  ...
                  <div className="bg-[#254E70]/5 p-4 h-1/2 flex flex-col">
                    <div className="text-center text-[#254E70] font-mono text-sm mb-2">WORDPRESS FRONTEND</div>
                    <div className="flex-grow flex items-center justify-center">
              ...
              <div className="mt-2 flex items-center justify-center">
                <div className="text-xs text-[#254E70]/60 mr-2">Page Load:</div>
                <div className="h-2 w-48 bg-[#254E70]/10 rounded-full overflow-hidden">
                  <div className="h-full w-1/3 bg-[#254E70]/40"></div>
                </div>
                <div className="text-xs text-[#254E70]/60 ml-2">Slower</div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="text-center mb-4">
                <h4 className="inline-block font-serif text-lg text-[#D97C4E] px-4 py-1 bg-[#D97C4E]/5 rounded-sm">Headless WordPress</h4>
              </div>
              ...
              <div className="relative aspect-[5/3] border border-[#D97C4E]/10 rounded-sm bg-[#F2EEE4] p-4 shadow-sm">
                ...
                <div className="absolute left-4 top-4 bottom-4 w-[45%] border-4 border-[#48A9A6]/30 border-dashed rounded-sm p-4 flex flex-col">
                  <div className="text-center text-[#48A9A6] font-mono text-sm mb-2">WORDPRESS BACKEND</div>
                  <div className="flex space-x-3 mb-2">
                ...
                <div className="absolute right-4 top-4 bottom-4 w-[45%] border-4 border-[#D97C4E]/30 border-dashed rounded-sm p-4 flex flex-col">
                  <div className="text-center text-[#D97C4E] font-mono text-sm mb-2">MODERN FRONTEND</div>
                  <div className="flex space-x-3 mb-2 justify-center">
                    <div className="px-2 py-1 bg-[#D97C4E]/20 rounded-sm text-[#D97C4E] text-xs">React</div>
                    <div className="px-2 py-1 bg-[#D97C4E]/20 rounded-sm text-[#D97C4E] text-xs">Next.js</div>
                  </div>
                  <div className="flex-grow flex items-center justify-center">
              ...
              <div className="mt-2 flex items-center justify-center">
                ...
                <div className="text-xs text-[#254E70]/60 ml-2">Faster</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#48A9A6] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Performance Optimized</h3>
          ...
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#D97C4E] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Enhanced Security</h3>
            <p className="text-[#254E70]/70">
          ...
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#946B4A] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Seamless Integration</h3>
            <p className="text-[#254E70]/70">
          ...
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#254E70] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Content Freedom</h3>
            <p className="text-[#254E70]/70">
          ...
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#48A9A6] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Mobile Excellence</h3>
            <p className="text-[#254E70]/70">
          ...
          <div className="bg-[#F2EEE4] rounded-sm p-6 shadow-sm border border-[#254E70]/10 hover:border-[#D97C4E] transition-colors duration-300">
            ...
            <h3 className="font-serif text-xl text-[#254E70] mb-2">Future-Proof</h3>
            <p className="text-[#254E70]/70">
        ...
        <div className="mt-24 border border-[#254E70]/10 rounded-sm overflow-hidden">
          <div className="bg-[#254E70] text-white p-6">
            <h3 className="font-serif text-2xl">The CuratorAI Approach to Headless WordPress</h3>
            <p className="text-white/80 mt-2">
              We've helped dozens of museums and cultural institutions transition to headless architecture without disruption.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-[#48A9A6]/10 flex items-center justify-center mb-4">
                  <div className="font-mono text-[#48A9A6] text-lg">01</div>
                </div>
                <h4 className="font-medium text-[#254E70] mb-2">Analysis & Planning</h4>
                <p className="text-[#254E70]/70 text-sm">
                  We assess your current site, content needs, and organizational goals to create a tailored transition plan.
                </p>
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-[#D97C4E]/10 flex items-center justify-center mb-4">
                  <div className="font-mono text-[#D97C4E] text-lg">02</div>
                </div>
                <h4 className="font-medium text-[#254E70] mb-2">Backend Optimization</h4>
                <p className="text-[#254E70]/70 text-sm">
                  We optimize your WordPress installation for headless use, configuring APIs and content structures.
                </p>
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-[#946B4A]/10 flex items-center justify-center mb-4">
                  <div className="font-mono text-[#946B4A] text-lg">03</div>
                </div>
                <h4 className="font-medium text-[#254E70] mb-2">Frontend Development</h4>
                <p className="text-[#254E70]/70 text-sm">
                  We build a blazing-fast, accessible frontend using React and Next.js tailored to your institution's aesthetic.
                </p>
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-[#254E70]/10 flex items-center justify-center mb-4">
                  <div className="font-mono text-[#254E70] text-lg">04</div>
                </div>
                <h4 className="font-medium text-[#254E70] mb-2">Training & Support</h4>
                <p className="text-[#254E70]/70 text-sm">
                  We ensure your team is comfortable with the new setup and provide ongoing maintenance and support.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#F2EEE4] rounded-sm p-6 border border-[#48A9A6]/10 z-10">
              <blockquote className="text-[#254E70] text-lg italic mb-6">
                The transition to headless WordPress transformed our digital presence. Our page load times decreased by 68%, and our team still uses the familiar WordPress interface they know and love. CuratorAI guided us through every step of the process with expertise and patience.
              </blockquote>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-[#254E70] font-medium">Dr. Maria Hernandez</div>
                  <div className="text-[#254E70]/60 text-sm">Digital Director, Pacific Maritime Museum</div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 bg-[#254E70] rounded-sm p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h3 className="font-serif text-2xl mb-4">Ready to modernize your institution's website?</h3>
            <p className="text-white/80 mb-8">
              Discover how CuratorAI's headless WordPress solutions can transform your digital presence while preserving the familiar WordPress experience your team relies on.
            </p>
