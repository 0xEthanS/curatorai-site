			...
			<section className="relative bg-[#254E70] text-white overflow-hidden">
				...
				<div className="container mx-auto px-6 py-24 md:py-32 relative z-10">
					<div className="max-w-3xl mx-auto text-center">
						<h4 className="font-mono text-[#48A9A6] text-sm tracking-wider mb-3 animate-fade-in-up">
							GET IN TOUCH
						</h4>
							...
							<div className="sticky top-8">
								...
								<div className="space-y-6 mb-8">
									...
									<div className="flex items-start">
										...
										<div>
											<h3 className="font-medium text-[#254E70] mb-1">
												Email
											</h3>
											<a 
												href="mailto:hello@curatorai.com" 
												className="text-[#D97C4E] hover:underline">
												hello@curatorai.com
											</a>
											<p className="text-sm text-[#254E70]/60 mt-1">
								...
								<div className="border-t border-[#254E70]/10 pt-8 mb-8">
						 			...
						 			{/*
									<h3 className="font-medium text-[#254E70] mb-4">
										Connect With Us
									</h3>
									<div className="flex space-x-4">
										<a 
											href="#" 
											className="w-10 h-10 rounded-sm bg-[#254E70]/5 flex items-center justify-center text-[#254E70] hover:bg-[#254E70]/10 transition-colors"
										>
							...
							<div className="bg-white rounded-sm shadow-md border border-[#254E70]/10 overflow-hidden">
								...
								<div className="px-8 py-6 bg-[#254E70]">
									...
									<p className="text-white/70 mt-2">
										Let us know how we can help your institution embrace digital solutions.
									</p>
								</div>
					...
					<div className="max-w-4xl mx-auto">
						<div className="space-y-6">
							...
							<div className="bg-[#F2EEE4] rounded-sm shadow-sm border border-[#254E70]/10 overflow-hidden">
								<div className="px-6 py-4 cursor-pointer flex justify-between items-center">
									<h3 className="font-medium text-[#254E70]">
										Do we need technical staff to maintain these systems?
									</h3>
									<svg className="w-5 h-5 text-[#254E70]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
										<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 9l-7 7-7-7" />
									</svg>
							...
							<div className="bg-[#F2EEE4] rounded-sm shadow-sm border border-[#254E70]/10 overflow-hidden">
								<div className="px-6 py-4 cursor-pointer flex justify-between items-center">
									<h3 className="font-medium text-[#254E70]">
										What makes CuratorAI different from other technology providers?
									</h3>
									<svg className="w-5 h-5 text-[#254E70]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
										<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 9l-7 7-7-7" />
									</svg>
