...
export default function Header() {
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/services" className="text-[#254E70] hover:text-[#D97C4E] transition-colors py-2">
              Services
            </Link>
            <Link href="/about" className="text-[#254E70] hover:text-[#D97C4E] transition-colors py-2">
              About
            </Link>
            <Link href="/case-studies" className="text-[#254E70] hover:text-[#D97C4E] transition-colors py-2">
              Case Studies
            </Link>
        ...
        <div className="mobile-menu hidden md:hidden">
          <div className="pt-4 pb-2 space-y-1">
            <Link href="/services" className="block py-2 px-4 rounded-sm hover:bg-[#254E70]/5">
              Services
            </Link>
            <Link href="/about" className="block py-2 px-4 rounded-sm hover:bg-[#254E70]/5">
              About
            </Link>
            <Link href="/case-studies" className="block py-2 px-4 rounded-sm hover:bg-[#254E70]/5">
              Case Studies
            </Link>
  ...
  // Note: In a real implementation, you would need to add client-side JavaScript
  // to handle the mobile menu toggle functionality, or use 'use client' directive
  // at the top of this file and implement the toggle state with useState.
}