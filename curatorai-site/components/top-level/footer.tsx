...
export default function Footer() {
	return (
		<footer className="bg-[oklch(14.1%_.005_285.823)] pt-20 dark:bg-transparent">
			<div className="mx-auto max-w-5xl px-6">
				...
				<div className="grid gap-12 md:grid-cols-5">
					...
					>
							...
							>
								...
								{link.items.map((item, index) => (
									<Link
										key={index}
										href={item.href}
										className="text-slate-50 hover:text-primary block duration-150"
									>
										<span>
											{item.title}
										</span>
						...
						<div className='space-y-4 text-sm'>
							...
							<div className='block text-slate-100'>
								{contact.email}
							</div>
							<div className='block text-slate-100'>
								{contact.number}
				...
				<div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
					<span className="text-muted-foreground order-last block text-center text-sm md:order-first">
						© {new Date().getFullYear()} CuratorAI, All rights reserved
					</span>
					<div className="order-first flex flex-wrap justify-center gap-6 text-sm md:order-last">
						...
						{/* Twitter 
						<Link target="_blank" rel="noopener noreferrer" aria-label="X/Twitter" className="text-muted-foreground hover:text-primary block"
							href="#"
						>
						...
						*/}
						...
						{/* Linkedin 
						<Link target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-primary block" 
							href="#"
						>
						...
						*/}
						...
						{/* Facebook 
						<Link target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground hover:text-primary block"
							href="#"
						>
						...
						*/}
						...
						{/* Threads 
						<Link target="_blank" rel="noopener noreferrer" aria-label="Threads" className="text-muted-foreground hover:text-primary block"
							href="#"
						>
						...
						*/}
						...
						{/* Instagram 
						<Link target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-primary block"
							href="#"
						>
						...
						*/}
						...
						{/* Tiktok 
						<Link target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-muted-foreground hover:text-primary block"
							href="#"
						>
