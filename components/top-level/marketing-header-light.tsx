		...
		<header className="bg-white">
			<nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
								...
								{resources.map((item) => (
									...
									>
										<div className="flex size-11 flex-none items-center justify-center rounded-lg bg-zinc-50 group-hover:bg-white">
											<item.icon aria-hidden="true" className="size-6 text-zinc-600 group-hover:text-indigo-600" />
										</div>
				...
				<div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center gap-4">
					...
					<a href="/signin" className="text-sm/6 font-semibold text-zinc-900">
						Sign in
					</a>
						...
						<div className="-my-6 divide-y divide-zinc-500/10">
							<div className="space-y-2 py-6">
								...
								<Disclosure as="div" className="-mx-3">
									<DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pr-3.5 pl-3 text-base/7 font-semibold text-zinc-900 hover:bg-zinc-50">
										Product
									...
									<DisclosurePanel className="mt-2 space-y-2">
										{[
											...
											<DisclosureButton
												...
												as="a"
												href={item.href}
												className="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-semibold text-zinc-900 hover:bg-zinc-50"
											>
												{item.name}
											</DisclosureButton>
										))}
